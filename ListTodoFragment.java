...
public class ListTodoFragment extends Fragment {
    ...
    private class TodoHolder extends RecyclerView.ViewHolder{
        TextView title, date, description,status,  priority;
        CheckBox completed;
        ...
        public TodoHolder(LayoutInflater inflater, ViewGroup parent){
            ...
            priority = itemView.findViewById(R.id.priority_color_id);
...
//            LinearLayout layout =(LinearLayout)((ViewGroup)holder.priority.getParent());
            LinearLayout color_layout =(LinearLayout)((ViewGroup)holder.priority.getParent());
//            TextView clr_layout =(TextView)holder.priority.getParent();

            switch (todo.getPriority()) {
                case 1:
                    color_layout.setBackgroundColor(getResources().getColor(R.color.color_high));
                    break;
                case 2:
                    color_layout.setBackgroundColor(getResources().getColor(R.color.color_medium));
                    break;
                case 3:
                    color_layout.setBackgroundColor(getResources().getColor(R.color.color_low));
                    break;
            }
            holder.bind(todo);
        }
